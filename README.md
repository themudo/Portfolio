...
I prepared four different queries, one for myself (h-index: 17, time of first publication 2007) (https://w.wiki/6N2E), one for long-lived academic [E. O. Wilson](https://en.wikipedia.org/wiki/E._O._Wilson) (https://w.wiki/6N5s) publishing since at least the 1950's until his death in 2021, one for the topic "Comparative Genomics" (https://w.wiki/6N2C), and the last one for the topic "Mycobacterium bovis" (https://w.wiki/6N2B).
